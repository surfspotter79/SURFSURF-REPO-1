...
import { ArrowRight, Camera, MapPin, Users, Search, ChevronDown, Star, TrendingUp, Award, Clock } from 'lucide-react';
...
const LandingPage: React.FC<LandingPageProps> = ({ 
  ...
  const getTopPhotographers = () => {
    ...
    return Object.values(photographerStats)
    ...
    <div className="min-h-screen">
      ...
      >
        ...
        <div className="relative z-10 text-center text-white max-w-4xl mx-auto px-4">
          <h1 className="text-6xl md:text-8xl font-bold mb-6 leading-tight">
            Epic Surf
            <span className="block text-orange-400">Photography</span>
          </h1>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              Meet the talented photographers capturing the stoke
            </p>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              The latest surf photography from our community
            </p>
          </div>
      ...
      <section className="py-16 bg-yellow-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Major Surf Events & Competitions
            </h2>
            <p className="text-lg text-gray-700">
              Follow the world's best surf competitions and events
            </p>
          </div>
          
          <div className="flex justify-center items-center space-x-8 flex-wrap gap-y-4">
            <a href="https://www.worldsurfleague.com" target="_blank" rel="noopener noreferrer" className="group hover:scale-110 transition-transform">
            ...
            <a href="https://www.vanstriplecrownofsurfing.com" target="_blank" rel="noopener noreferrer" className="group hover:scale-110 transition-transform">
            ...
            <a href="https://www.quiksilver.com" target="_blank" rel="noopener noreferrer" className="group hover:scale-110 transition-transform">
              <div className="w-16 h-16 bg-yellow-50 rounded-full flex items-center justify-center shadow-lg overflow-hidden">
                <span className="text-gray-800 font-bold text-xs">QUIK</span>
              </div>
            </a>
            <a href="https://www.ripcurl.com" target="_blank" rel="noopener noreferrer" className="group hover:scale-110 transition-transform">
              <div className="w-16 h-16 bg-yellow-50 rounded-full flex items-center justify-center shadow-lg overflow-hidden">
                <span className="text-gray-800 font-bold text-xs">RIP</span>
              </div>
            </a>
            <a href="https://www.billabong.com" target="_blank" rel="noopener noreferrer" className="group hover:scale-110 transition-transform">
              <div className="w-16 h-16 bg-yellow-50 rounded-full flex items-center justify-center shadow-lg overflow-hidden">
